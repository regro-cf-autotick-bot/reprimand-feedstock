...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/reprimand-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/reprimand-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `reprimand` available on your platform:
...
```
pixi search reprimand --channel conda-forge
```
